...
const JobCreatePage = () => {
    ...
    return (
        <div className="job-create-page" style={{
            ...
            <Card
                title={<span style={{ fontSize: "24px", fontWeight: "bold" }}>Tạo công việc mới</span>}
                style={{width: "100%", maxWidth: "900px", boxShadow: "0px 4px 12px rgba(0, 0, 0, 0.1)", textAlign: "center"}}
            >
