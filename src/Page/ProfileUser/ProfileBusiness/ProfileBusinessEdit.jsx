...
import {update_business} from "../../../Redux/actions/BusinessThunk";
...
const ProfileBusinessEdit = () => {
    ...
    const [formValues, setFormValues] = useState({
        ...
        licenseImage: business?.licenseImage || '',
        descriptionLocation: business?.descriptionLocation || '',
        provinceId: business?.provinceId || '',
        districtId: business?.districtId || '',
        wardId: business?.wardId || '',
    });

    const logoUrl = formValues.businessImage ? `${GET_IMAGE_URI}${formValues.businessImage}` : '';
    const licenseUrl = formValues.licenseImage ? `${GET_IMAGE_URI}${formValues.licenseImage}` : '';
    ...
    const handleSubmit = (event) => {
        ...
        dispatch(update_business(business.id, formData));
    };
