const body = document.body, root = document.getElementById("root"), colorChangedEv = new CustomEvent("scheme-changed"),
...
if (document.getElementById("_dm-settingsContainer")) {
    const f = {
        ...
        h = document.getElementById("_dm-boxedBgOption"), i = (f.boxedLayoutRadio.addEventListener("changed", e => {
        ...
        }), document.getElementById("_dm-transitionSelect")), j = (i.addEventListener("change", e => {
            e = e.target;
        ...
        }), document.getElementById("_dm-offcanvas")), k = new bootstrap.Offcanvas(j),
        l = document.getElementById("_dm-settingsToggler"), m = document.getElementById("_dm-settingsContainer"),
        ...
        }), document.getElementById("dm_colorSchemesContainer")), p = o.querySelectorAll("._dm-colorSchemes"),
        q = document.documentElement.getAttribute("data-scheme"), r = (p.forEach(e => {
        ...
        }), m.querySelector("#_dm-fontSizeRange")), w = m.querySelector("#_dm-fontSizeValue"), x = (e, t, a, o) => {
            var d = e.value, n = e.min || 0, e = e.max || 100, e = Number(100 * (d - n) / (e - n));
        ...
        }), z = y("bootstrap.").getAttribute("href"), A = z.match(/^.*?assets/g).toString(), B = {
            className: "os-nifty-minimal",
            scrollbars: {autoHide: "leave", clickScrolling: !0},
            overflowBehavior: {x: "visible-scroll"}
        }, C = () => new Promise((t, a) => {
            if (document.getElementById("_dm-jsOverlayScrollbars")) t("done"); else {
                let e = document.createElement("link");
                e.setAttribute("id", "_dm-cssOverlayScrollbars"), e.setAttribute("rel", "stylesheet"), e.setAttribute("href", A + "/vendors/overlayscrollbars/overlayscrollbars.min.css"), document.querySelector("head").append(e), (e = document.createElement("script")).setAttribute("id", "_dm-jsOverlayScrollbars"), e.setAttribute("src", A + "/vendors/overlayscrollbars/overlayscrollbars.browser.es6.min.js"), document.body.append(e), e.addEventListener("load", t, {once: !0}), e.onerror = a
            }
        });
